...
class AppColors {
  ...
  static Color sideMenu =  Colors.black;
  ...
  static const Color containerGrey = Color(0xFFF3F3F3);
  static const Color containrGrey = Color(0xFFF2F2F2);
  static const Color lightGreyColor = Color(0xFFEBEBEB);
  static const Color orang = Color(0xFFFF8E29);
  static const Color buttonGreen = Color(0xFF17E3D2);
  static const Color lightBlue = Color(0xFFEEF4FF);
  static const Color textFieldBorder = Color(0xFFD6D6D6);
  static const Color textField = Color(0xFFF1F3F7);
  static const Color lightBlack = Color(0xFF333333);
  static const Color lightorange = Color(0xFFE8DEDE);

  static Color greenColor = Colors.green;

  static Color lightgreenColor = const Color.fromARGB(255, 153, 228, 162);
  static Color lightGrey = const Color(0xFFF5F5F5);
  static Color fadeGrey = const Color(0xffE2E2E2);
